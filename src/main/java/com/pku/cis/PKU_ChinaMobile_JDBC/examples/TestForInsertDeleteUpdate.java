...
public class TestForInsertDeleteUpdate  {
    static JFrame f;
    ...
    public static void main(String args[])
    {
        ...
        btn.addActionListener(new Adapter_TestForInsertDeleteUpdate());
...
class Adapter_TestForInsertDeleteUpdate implements ActionListener
{
