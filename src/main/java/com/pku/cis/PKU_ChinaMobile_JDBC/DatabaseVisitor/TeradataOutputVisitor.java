...
public class TeradataOutputVisitor extends SQLASTOutputVisitor implements OracleASTVisitor {
    ...
    public TeradataOutputVisitor(Appendable appender, boolean printPostSemi){
        super(appender);
