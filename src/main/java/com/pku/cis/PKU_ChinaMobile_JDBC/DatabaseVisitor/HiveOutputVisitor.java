...
public class HiveOutputVisitor extends SQLASTOutputVisitor implements OracleASTVisitor {
    ...
    public HiveOutputVisitor(Appendable appender, boolean printPostSemi){
        super(appender);
    ...
    public boolean visit(SQLMethodInvokeExpr x) {
    	System.out.println("In HiveOutputVisitor.visit(SQLMethodInvokeExpr)");
        ...
        MethodInformation miInformation = mapping.ToHiveFunction(methodKey); 
