...
public class MySqlOutputVisitor extends SQLASTOutputVisitor implements OracleASTVisitor {
    ...
    public MySqlOutputVisitor(Appendable appender, boolean printPostSemi){
        super(appender);
